  ...
  return (
    <main className="mx-auto max-w-2xl px-3 py-6 sm:px-4">
      ...
      <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
        <div>
          <h1 className="text-xl font-black uppercase tracking-[0.14em] text-zinc-100">Community</h1>
          <p className="mt-1 text-[10px] uppercase tracking-[0.1em] text-zinc-600">Mog Court · Looksmax Logs · Rate Me · Theory</p>
        </div>
        <button
          type="button"
          onClick={() => setShowCreate(true)}
          className="inline-flex h-9 items-center gap-1.5 border border-purple-500/50 bg-purple-950/30 px-3 text-[10px] font-black uppercase tracking-[0.12em] text-purple-100 transition-colors hover:border-purple-300 hover:text-white"
        >
      ...
      {/* Sort tabs */}
      <div className="mt-4 flex items-center gap-1 border-b border-zinc-800 pb-3">
        {([
      ...
      {/* Create post modal */}
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 p-3 backdrop-blur-sm sm:items-center">
      ...
      {/* Feed */}
      <div ref={feedRef} className="mt-4 flex flex-col gap-3">
        {posts.map((post) => (
          <PostCard
            key={post.id}
            post={post}
        ...
        {nextCursor && !loading && (
          <button
            type="button"
            onClick={() => { setCursor(nextCursor); void fetchFeed(nextCursor); }}
    ...
    <div className={cn("border bg-black/60", post.is_pinned ? "border-amber-500/30" : "border-zinc-800")}>
      ...
      <div className="flex">
        ...
        <div className="flex w-10 flex-col items-center border-r border-zinc-800 py-2">
          ...
          <span className={cn("text-xs font-black tabular-nums", score > 0 ? "text-purple-300" : score < 0 ? "text-red-300" : "text-zinc-500")}>
            {score}
          </span>
...
function PostDetail({
  ...
  return (
    <main className="mx-auto max-w-2xl px-3 py-6 sm:px-4">
      ...
      <div className="mt-4 border border-zinc-800 bg-black/60">
        <div className="flex">
          <div className="flex w-10 flex-col items-center border-r border-zinc-800 py-2">
      ...
      {/* Comment input */}
      <div className="mt-4 border border-zinc-800 bg-black/40 p-3">
        {replyTo && (
